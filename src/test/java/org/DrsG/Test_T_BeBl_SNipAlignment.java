...
@DisplayName("The T_BeBl_SNipAlignment Test Class")  // give meaningful display name
public class Test_T_BeBl_SNipAlignment
{
    private Test_T_BeBl_SNipAlignment()
    {
        // If constructor required, write here
    }

    @Test
    @DisplayName("The SNiPAlignment Test Case")
    // give meaningful display name
    void testSNipAlignment()
    {
        // GIVEN
        ...
        System.out.println("The SNipAlignment is performed");
        T_BeBl_SNiPAlignment sNiPAlignmentCreator = new T_BeBl_SNiPAlignment();
        String snipString;
        snipString = sNiPAlignmentCreator.perform(aRepository.getOptimalAlignment());
